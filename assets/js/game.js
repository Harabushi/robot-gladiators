...
var endGame = function() {
    if (playerInfo.health >0) {
        window.alert("Great job, you've survivded the game! You now have a score of " + playerInfo.money + ".");
    }
    else {
...
switch (shopOptionPrompt) {
    ...
    // case doesn't use {} and uses : instead of ; this whole setup is weird to me
    case "REFILL":
    case "refill":
